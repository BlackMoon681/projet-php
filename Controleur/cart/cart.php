...
$sql = "INSERT INTO `commande` (`id`,`email`,`service`,`qte`,`total`)
 VALUES ('','$aa','$ss','$qq','$subtotal');";
...
<div class="cart content-wrapper">
  ...
  <form method="POST" action="../cart/index.php?page=products" enctype="multipart/form-data">
  
    <div class="inputbox">
      <input type="submit" name="cmnd" value="Valider la commmande">
    </div>
